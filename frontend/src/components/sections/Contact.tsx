                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                        <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow text-center">
                            ...
                            <a href="mailto:Brandturnofficial@gmail.com" className="font-semibold hover:underline text-sm block break-all text-left" style={{ color: '#1a4d4d', wordBreak: 'break-word', overflowWrap: 'break-word' }}>Brandturnofficial@gmail.com</a>
                        </div>
                        <div className="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-shadow text-center">
                            <div className="w-12 h-12 rounded-full mx-auto mb-4 flex items-center justify-center" style={{ backgroundColor: '#1a4d4d' }}>
